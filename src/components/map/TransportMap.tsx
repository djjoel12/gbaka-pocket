...
const currentIcon = L.divIcon({
  ...
  html: `<div style="background-color:#2563eb; width:20px; height:20px; border-radius:50%; border:3px solid white; box-shadow:0 0 0 8px rgba(37,99,235,0.4); animation: pulse 1.5s infinite;"></div>`,
  iconSize: [20, 20],
  iconAnchor: [10, 10],
});
...
const startIcon = L.divIcon({
  ...
  html: `<div style="background-color:#22c55e; width:24px; height:24px; border-radius:50%; border:3px solid white; box-shadow:0 0 0 6px rgba(34,197,94,0.4);"></div>`,
  iconSize: [24, 24],
  iconAnchor: [12, 12],
});
...
const endIcon = L.divIcon({
  className: "custom-marker",
  html: `<div style="background-color:#ef4444; width:24px; height:24px; border-radius:50%; border:3px solid white; box-shadow:0 0 0 6px rgba(239,68,68,0.4);"></div>`,
  iconSize: [24, 24],
  iconAnchor: [12, 12],
});
...
const pointIcon = L.divIcon({
  className: "custom-marker",
  html: `<div style="background-color:#3b82f6; width:10px; height:10px; border-radius:50%; border:2px solid white; box-shadow:0 0 0 3px rgba(59,130,246,0.3);"></div>`,
  iconSize: [10, 10],
  iconAnchor: [5, 5],
});
    ...
    <div className="h-full w-full">
      ...
      >
        ...
        {routePositions.length > 1 && (
          <>
            <Polyline positions={routePositions} pathOptions={{ color: "white", weight: 12, opacity: 0.6, lineJoin: "round" }} />
            <Polyline positions={routePositions} pathOptions={{ color: "#2563eb", weight: 5, opacity: 1, lineJoin: "round" }} />
          </>
        )}
